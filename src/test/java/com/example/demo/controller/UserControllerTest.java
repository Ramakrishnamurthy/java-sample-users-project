...
public class UserControllerTest {
    ...
    @Test
    @DisplayName("Add user returns success message and calls service")
    void testAddUser() {
    ...
    @Test
    @DisplayName("Get sorted users returns sorted list")
    ...
    @Test
    @DisplayName("Get grouped by domain returns correct map")
    ...
    @Test
    @DisplayName("Search by name returns correct filtered list")
